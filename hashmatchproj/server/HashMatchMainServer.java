...
public class HashMatchMainServer {
    ...
    public static void main(String[] args) {
        ...
        if (args != null && args.length < 3) {
            ...
            //1. ============ Create Servant ============
            HashMatchMainServer hws = new HashMatchMainServer(args);
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                //============ Create Servant ============
                hashMatchFactoryRI = new HashMatchFactoryImpl();
                ...
                registry.rebind(serviceUrl, hashMatchFactoryRI);
